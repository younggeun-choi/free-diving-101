...
import { formatTime, calculateTotalTime } from '@/features/co2-table-trainer/lib/format-time';
    ...
    >
      <View className="px-4 py-6">
        ...
        <Card className="p-6 mb-6">
          ...
          <Text
            ...
            className={`text-center mb-4 ${
              isBreathing ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'
            }`}
          >
          ...
          {/* Large Timer */}
          <Text variant="h1" className="text-center font-mono mb-6">
          ...
          <View className="space-y-3">
            {/* Breathe Progress */}
            <View>
              <Text variant="small" className="mb-1 text-blue-600 dark:text-blue-400">
            ...
            {/* Hold Progress */}
            <View>
              <Text variant="small" className="mt-2 mb-1 text-orange-600 dark:text-orange-400">
        ...
        <View className="gap-3 mb-6">
          {!isRunning && (
            <Button size="lg" onPress={start} className="bg-blue-600">
              ...
              return (
                <View
                  ...
                  className={`py-2 px-3 rounded-lg mb-1 ${
                    isCurrentRound ? 'bg-blue-100 dark:bg-blue-900' : ''
                  }`}
                >
                  <Text
                    variant="small"
                    className={`font-semibold ${isCurrentRound ? 'text-blue-600 dark:text-blue-400' : ''}`}
                  >
